    ...
    return (
        <div className='card'>
            <div className='card-header'>
                <div className='card-title'><strong>Transaction Details</strong></div>
            </div>
            <div className='card-body mz-details'>
                <div className='row p-4'>
                    <div className='col-6 d-flex  justify-content-between px-4'>
                        <h6>Date: </h6>
                        <h6>{format(new Date(state.date), "MM/dd/yyy")}</h6>
                    </div>
                    <div
                        className='col-6 d-flex  justify-content-between px-4'
                        style={{ overflowWrap: "anywhere" }}
                    >
                        <h6>Transaction ID: </h6>
                        <h6>{state.transactionid}</h6>
                    </div>
                </div>
                <div className='row p-4'>
                    <div className='col-6 d-flex  justify-content-between px-4'>
